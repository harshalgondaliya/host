...
const comicSansStyle = {
  fontFamily: '"Comic Sans MS", "Comic Sans", "Chalkboard SE", "TSCu_Comic", cursive',
...
const Body = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full h-full bg-yellow-400 p-0 overflow-y-auto" style={comicSansStyle}>
      <br />
      <br />
      ...
      <div className="sm:hidden w-full max-w-4xl text-center my-6 px-5">
        <br /><br /><br />
        <h1
          className="text-2xl font-bold text-[#015c01] mb-2"
        ...
        >
          At TooMore, we believe nature holds the secret to the best flavors. Our juices are crafted from hand-picked fruits, 
          free from additives. Every sip delivers pure, refreshing goodness straight from orchard to glass.
        </p>
        <button
      ...
      <div className="w-full max-w-4xl text-center my-10 px-4">
        ...
        >
          We select the freshest, sun-ripened fruits at their peak. From orchard to bottle, 
          every sip is a celebration of flavor and nutrition.
        </p>
        <button
          className="mt-4 bg-[#015c01] text-white px-6 py-2 rounded-full hover:bg-[#013b01] transition-colors duration-300 shadow-lg hover:shadow-xl hover:scale-105"
        ...
        {imagesWithDesc.slice(0, 3).map((image, index) => (
          ...
          >
            <img
              ...
              loading="lazy"
            />
            <p className="mt-3 text-base text-[#015c01] font-light" style={{...comicSansStyle, fontSize: '1rem'}}>
              {image.desc}
            </p>
            <h3 className="mt-1 text-lg text-[#015c01] font-bold" style={{...comicSansStyle, fontSize: '1.2rem'}}>
              {image.desc1}
            </h3>
          </div>
        ))}
      ...
      <div className="sm:hidden w-full overflow-x-scroll scroll-smooth snap-x snap-mandatory px-4 py-2 my-4">
        <h2 className="text-xl font-bold text-[#015c01] mb-3 text-center" style={{...comicSansStyle, fontSize: '1.5rem'}}>
          Our Flavors
        </h2>
        <div
          ref={scrollRef}
          ...
          {imagesWithDesc.map((image, index) => (
            ...
            >
              ...
              <div className="p-3 text-center">
                <h3 className="text-lg text-[#015c01] font-bold" style={{...comicSansStyle, fontSize: '1.2rem'}}>
                  {image.desc1}
                </h3>
                <p className="mt-1 text-base text-[#015c01]" style={{...comicSansStyle, fontSize: '1rem'}}>
                  {image.desc}
                </p>
              </div>
            </div>
        ...
        <div className="flex justify-center mt-2">
          <div className="flex space-x-2">
            {imagesWithDesc.map((_, index) => (
              <div key={index} className="h-2 w-2 rounded-full bg-[#015c01]"></div>
            ))}
          </div>
        </div>
      </div>
      ...
      <div className="w-full max-w-4xl text-center my-10">
        ...
        <p
          ...
          style={{...comicSansStyle, fontSize: '1.4rem'}}
        >
          We're hand-picking oranges at their peak, squeezing them within 
      ...
      <div id="banner-image" className="w-full shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-105 lazy-container">
        <img 
          src={end} 
          alt="Soft Front" 
          className="w-full h-auto" 
